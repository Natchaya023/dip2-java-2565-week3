public class Main {
    public static void main(String[] args) {
        System.out.print("Bitwise Operator!");
        int a = 12; // 0000 0101
        int b = 25; // 0000 0010
        int c = 35; // 0010 0011
        int d = 3; // 0000 0010
        ...
        val = d<<2; System.out.println("Output of Bitwise Signed Left Shift: " + val);
        val = e>>3; System.out.println("Output of Bitwise Signed Right Shift: " + val);
        val = f>>>2; System.out.println("Output Bitwise Unsigned Right Shift: " + val);
